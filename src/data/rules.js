export const rules = [
  ...
  },
  {
    ...
    explanation: "New members need to be strong enough to join. So, any player who has less than 800K Titans and 1M Heroes is welcome only if we are less than 29 mates! Nothing personal but at this point we need only strongs new mates! This rule doesn't apply to old mates!"
  }
  , {
    id: 3,
